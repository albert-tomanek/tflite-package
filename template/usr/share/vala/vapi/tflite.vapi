// A thin wrapper around the TensorFlow Lite C API. Should be pretty version agnostic as the C API aims for ABI stability.
// Documentation is in the header file. https://github.com/tensorflow/tensorflow/blob/master/tensorflow/lite/c/c_api.h
